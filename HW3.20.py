...
letter_price = {1: 'AEIOULNSTRАВЕИНОРСТ', 2: 'DGДКЛМПУ', 3: 'BCMPБГЁЬЯ', 4: 'FHVWYЙЫ', 5: 'KЖЗХЦЧ', 8: 'JZШЭЮ', 10: 'QZФЩЪ'}
...
for i in word:
    if i in 'QWERTYUIOPASDFGHJKLZXCVBNMАВЕИНОРСТДКЛМПУБГЁЬЯЙЫЖЗХЦЧШЭЮФЩЪ':
        for j in letter_price:
            if i in letter_price[j]:
                count_price = count_price + j

print(f'Стоимость слова: {count_price}')